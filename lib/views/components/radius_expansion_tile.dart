...
/// See:
/// [ExpansionTile]
class RadiusExpansionTile extends StatefulWidget {
  ...
  @override
  _RadiusExpansionTileState createState() =>
      _RadiusExpansionTileState();
}

class _RadiusExpansionTileState extends State<RadiusExpansionTile>
  ...
  void initState() {
    ...
    _heightFactor = _controller.drive(RadiusExpansionTile._easeInTween);
    _iconTurns = _controller.drive(
        (widget.animatedWidgetTurnTween ?? RadiusExpansionTile._halfTween)
            .chain(widget.animatedWidgetTween ??
            RadiusExpansionTile._easeInTween));

    _borderColor = _controller.drive(_borderColorTween.chain(
        widget.borderAnimationTween ??
            RadiusExpansionTile._easeOutTween));
    _borderColorTween.end = widget.borderColorEnd;

    _headerColor = _controller.drive(_headerColorTween.chain(
        widget.headerAnimationTween ?? RadiusExpansionTile._easeInTween));

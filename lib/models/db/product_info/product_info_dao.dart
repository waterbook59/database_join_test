...
class ProductInfoDao extends DatabaseAccessor<MyProductInfoDB>
    with _$ProductInfoDaoMixin {
  ProductInfoDao(MyProductInfoDB infoDB) : super(infoDB);

  ///1.extension:List<Product>=>List<ProductRecord>,
  ///List<ProductRecordImages>に分ける
...
//    });
  ...
  Future<List<JoinedProduct>> insertAndJoinFromDB(List<ProductRecord> products,
